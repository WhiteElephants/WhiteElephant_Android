...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        DeliveryInformationDao.createTable(db, ifNotExists);
        CartOrderDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        DeliveryInformationDao.dropTable(db, ifExists);
        CartOrderDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(DeliveryInformationDao.class);
        registerDaoClass(CartOrderDao.class);
