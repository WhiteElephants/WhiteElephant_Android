package rawe.gordon.com.business.generals.pulls;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateTextView.setText(R.string.gs_refresh_succeed);
                refreshStateImageView.setBackgroundResource(R.drawable.blank_transparent);
                break;
            case FAIL:
            default:
                // 刷新失败
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateTextView.setText(R.string.gs_load_succeed);
                loadStateImageView.setBackgroundResource(R.drawable.blank_transparent);
                break;
            case FAIL:
            default:
                // 加载失败
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.gs_load_fail);
                loadStateImageView.setBackgroundResource(R.drawable.blank_transparent);
                break;
        }
        if (pullUpY < 0) {
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                refreshStateTextView.setText(R.string.gs_pull_to_refresh);
                pullView.clearAnimation();
                pullView.setVisibility(View.VISIBLE);
                // 上拉布局初始状态
                loadStateImageView.setVisibility(View.GONE);
                loadStateTextView.setText(R.string.gs_pullup_to_load);
                pullUpView.clearAnimation();
                pullUpView.setVisibility(View.VISIBLE);
                break;
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText(R.string.gs_release_to_refresh);
            ...
            case REFRESHING:
                ...
                refreshStateTextView.setText(R.string.gs_refreshing);
                break;
            case RELEASE_TO_LOAD:
                // 释放加载状态
                loadStateTextView.setText(R.string.gs_release_to_load);
            ...
            case LOADING:
                ...
                loadStateTextView.setText(R.string.gs_loading);
                break;
            case DONE:
                // 刷新或加载完毕，啥都不做
                break;
    ...
    private PullMode pullMode = PullMode.PULL_DOWN;

    enum PullMode {
        PULL_DOWN, PULL_UP, BOTH;
    }
