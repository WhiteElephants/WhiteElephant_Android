...
import rawe.gordon.com.selectimage.utils.PhotoDraweeViewUtil;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import rawe.gordon.com.selectimage.photodraweeview.PhotoDraweeView;
...
//        medias.addAll(Arrays.asList(new BrowseDetailModel(new MediaInfo()), new BrowseDetailModel(new MediaInfo()), new BrowseDetailModel(new MediaInfo())));
    ...
    private void addIcons() {
        backImage.setImageDrawable(DrawableUtil.decodeFromVector( R.drawable.ic_arrow_back));
        orginalImage.setImageDrawable(DrawableUtil.decodeFromVector( R.drawable.ic_radio_button_unchecked));
        chooseImage.setImageDrawable(DrawableUtil.decodeFromVector(R.drawable.ic_choosable));
    }
    ...
    public void setChosen(boolean chosen) {
        ...
        chooseImage.setImageDrawable(chosen ? DrawableUtil.decodeFromVector(
                R.drawable.ic_chosen) : DrawableUtil.decodeFromVector( R.drawable.ic_choosable));
    }
    ...
    public void setOriginal(boolean original) {
        isOriginal = original;
        orginalImage.setImageDrawable(original ? DrawableUtil.decodeFromVector(
                R.drawable.ic_radio_button_checked) : DrawableUtil.decodeFromVector( R.drawable.ic_radio_button_unchecked));
    }
